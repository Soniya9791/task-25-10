      ...
      <div className="border-b border-slate-200 bg-slate-100">
        <div className="mx-auto grid w-full max-w-full grid-cols-4 gap-6 px-6 py-2 text-sm text-slate-500 md:grid-cols-8 lg:max-w-5xl lg:grid-cols-12 xl:max-w-7xl 2xl:max-w-[96rem]">
          <div className="col-span-2 items-center md:col-span-4 lg:col-span-6">
            ...
            >
              <svg
                xmlns="https://i.pinimg.com/474x/04/38/11/04381104d75831ebbf960402d4f6dd5b.jpg"
                viewBox="0 0 24 24"
                fill="currentColor"
                className="h-4 w-4"
          ...
          >
            ...
            >
              <img
                ...
                src="https://i.pinimg.com/474x/f6/73/79/f67379c00cfce0d5ee8b6095f15bddc2.jpg"
                alt=""
              />
              <p className="text-violet-950 font-display ">Highly</p>
            </a>
            {/*      <!-- Mobile trigger --> */}
            <button
            ...
            <ul
              ...
              className={`absolute left-0 top-0 z-[-1] h-[28.5rem] w-full justify-center overflow-hidden font-display overflow-y-auto overscroll-contain bg-white/90 px-8 pb-12 pt-24 font-medium transition-[opacity,visibility] duration-300 lg:visible lg:relative lg:top-0  lg:z-0 lg:flex lg:h-full lg:w-auto lg:items-stretch lg:overflow-visible lg:bg-white/0 lg:px-0 lg:py-0  lg:pt-0 lg:opacity-100 ${
                isToggleOpen
            ...
            >
              <li role="none" className="flex items-stretch">
                <a
                  role="menuitem"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 transition-colors duration-100 text-violet-950 hover:text-2xl focus:text-violet-950 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                  onClick={()=>{
                    navigate("/")
                  }}
              ...
              <li role="none" className="flex items-stretch">
                <a
                  ...
                  aria-current="page"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 text-violet-950transition-colors duration-300 text-violet-950 hover:text-2xl focus:text-violet-950 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="javascript:void(0)"
                  onClick={()=>{
                    navigate("/women")
                  }}
            ...
            <div className="ml-auto flex items-center justify-end px-6 lg:ml-0 lg:flex-1 lg:p-0">
              <a
                href="#"
                className="flex items-center gap-2 py-4 text-violet-950transition-colors duration-300 hover:text-violet-950 focus:text-violet-950 focus:outline-none focus-visible:outline-none lg:px-8"
              >
                <i class="fa-solid fa-cart-shopping hover:text-2xl"></i>
              </a>
            </div>
          </nav>
        </div>
